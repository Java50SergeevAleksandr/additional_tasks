...
public class AdvPerson {
	...
	public boolean equals(Object o) {
		...
		return age == advPerson.age && Double.compare(advPerson.salary, salary) == 0 && name.equals(advPerson.name)
				&& address.equals(advPerson.address) && bday.equals(advPerson.bday);
	}
	...
	public String toString() {
		return "AdvPerson{" + "name='" + name + '\'' + ", age=" + age + ", address=" + address + ", salary=" + salary
				+ ", bday=" + bday + '}';
	}
}
